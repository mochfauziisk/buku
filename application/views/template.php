		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="<?=base_url()?>" style="font-size: 20px;">
					<i class="fa fa-book"></i><i><b> GRABOOK</b></i></a>
			</div>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="<?=base_url()?>" 
								<?php if ($judul=="Dashboard | Web - GRABOOK"): ?>
								class="active"
								<?php endif ?>>
						...
						<li>
							<a href="<?=base_url('index.php/buku')?>" 
								<?php if ($judul=="CRUD Buku | Web - GRABOOK"): ?>
									class="active"
								<?php endif ?>>
						...
						<li>
							<a href="<?=base_url('index.php/user')?>"
							 	<?php if ($judul=="CRUD User | Web - GRABOOK"): ?>
							 		class="active"
							 	<?php endif ?>>
						...
						<li>
							<a href="<?=base_url('index.php/kategori')?>"
								<?php if ($judul=="CRUD Kategori | Web - GRABOOK"): ?>
									class="active"
								<?php endif ?>>
						...
						<li>
							<a href="<?=base_url('index.php/history')?>" 
								<?php if ($judul=="History Transaksi| Web - GRABOOK"): ?>
									class="active"
								<?php endif ?>>
						...
						<li>
							<a href="<?=base_url('index.php/transaksi')?>"
								<?php if ($judul=="Transaksi | Web - GRABOOK"): ?>
									class="active"
								<?php endif ?>>
