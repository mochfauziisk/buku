    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
              <div class="header">
                            <h2>
                               <a style="" href="<?=base_url()?>" ><i style="font-size: 30px;color: black" class="lnr lnr-home"></i></a> CRUD BUKU
                            </h2>                          
                          </div> 
                <div class="body">
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                               <table class="table">
                                <form method="post" action="<?php echo base_url('index.php/buku/tambah')?>" enctype="multipart/form-data">
                                <tr>
                                  <td>Judul buku :</td>
                                  <td>
                                    <div class="input-group">
